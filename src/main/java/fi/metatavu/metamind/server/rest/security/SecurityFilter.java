...
import fi.metatavu.metamind.security.SecurityController;
...
public class SecurityFilter implements ContainerRequestFilter {
  ...
  private String decodeAuthorization(String authorization) {
    try {
      ...
      logger.warn("Invalid credential encoding", e);
      return null;
    }
  }
  ...
  private void handleUnuauthorizedRequest(ContainerRequestContext requestContext, String logMessage) {
    logger.warn(String.format("%s from %s", logMessage, getRequestDetails(requestContext)));
