...
public class KnotTestsIT extends AbstractFunctionalTest {
  ...
  public void testCreateKnot() throws Exception {
    try (TestBuilder builder = new TestBuilder()) {
      ...
      Assertions.assertNotNull(builder.admin().knots().create(story, KnotType.TEXT, "Test", "Content", 10.0, 20.0));
      Assertions.assertNotNull(builder.admin().knots().create(story, KnotType.TEXT, "Test Null", "Content", null, null));
    }
  }
